    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-md-10 offset-md-1">
          <img src="http://i.imgur.com/Qr71crq.jpg" class="user-img" data-bind="src: *** IMAGE *** " />
          <h4>{{ *** USERNAME *** }}Eric Simons</h4>
          <p>
            {{ *** BIO ***}}
          ...
          <button class="btn btn-sm btn-outline-secondary action-btn">
            ...
            &nbsp; Follow {{ *** USERNAME *** }}Eric Simons
          </button>
          <button class="btn btn-sm btn-outline-secondary action-btn" data-bind=" *** EDIT PROFILE *** ">
